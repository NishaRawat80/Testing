...
<head>
    ...
    <title>Rakar - Handyman Multipurpose Repairing Services HTML Template - Team Details</title>
...
==============================-->
    <section class="space">
        <div class="container">
            <div class="row gy-40">
                ...
                <div class="col-xl-8 col-md-6">
                    <div class="about-card">
                        <h2 class="mb-20 pb-1 sec-title">About Me</h2>
                        <p>Venenatis purus egestas lorem aenean enim bibendum. Ac pharetra egestas eget gravida turpis senectus. Sed blandit ipsum orci odio egestas egestas sed bibendum. Rhoncus est proin euismod condimentum eget a tristique integer viverra. Enim sed nunc magna consequat consectetur vestibulum odio posuere. Mattis nisl aenean auctor morbi suspendisse diam adipiscing. Tellus egestas amet tellus phasellus. <br> <br>
                            Ornare aliquam ac a pellentesque ante. Morbi maecenas odio integer adipiscing ridiculus mauris. Ornare in sit et tortor orci massa eu ultricies. Sit fermentum faucibu.</p>

                        <h4 class="mt-30 mb-20">5 Years of Experiences</h4>
                        <p class="mb-4">Venenatis purus egestas lorem aenean enim bibendum. Ac pharetra egestas eget gravida turpis senectus. Sed blandit ipsum orci odio egestas egestas sed bibendum. Rhoncus est proin euismod condimentum eget a tristique integer viverra.</p>
            ...
            <h4 class="mt-5 pt-xl-2 mb-30">Contact With Me</h4>
            <div class="row gy-4">
...
Team Area  
==============================-->
    <section class="bg-top-center space" data-bg-src="assets/img/bg/team_bg_5.jpg">
        <div class="container z-index-common">
            <div class="title-area text-center">
                <span class="sub-title shape-white"><img src="assets/img/theme-img/title_icon_white.svg" alt="shape">Team Members</span>
                <h2 class="sec-title text-white">Meet with Related Team</h2>
            </div>
