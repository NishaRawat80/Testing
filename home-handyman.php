                    ...
                    <div class="hero-inner">
                        <div class="container">
                            <div class="hero-style1">
                                ...
                                <h1 class="hero-title">
                                    <span class="title1" data-ani="slideinup" data-ani-delay="0.2s">We offer home</span>
                                    <span class="title2" data-ani="slideinup" data-ani-delay="0.4s">renovation & repair</span>
                                    <span class="title3" data-ani="slideinup" data-ani-delay="0.6s">since <span class="text-theme">2003</span></span>
                                </h1>
                                <p class="hero-text" data-ani="slideinup" data-ani-delay="0.8s">We believe in providing top quality workman and are so confident in our level of service that we back it up</p>
                                <a href="service.php" class="th-btn style3" data-ani="slideinup" data-ani-delay="1s">Our All Services<i class="fas fa-arrow-right ms-2"></i></a>
                            </div>
                        </div>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="service-card">
                                ...
                                <a href="service-details.php" class="th-btn btn-sm">Read More<i class="far fa-arrow-right ms-2"></i></a>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="service-card">
            ...
            <div class="row flex-row-reverse">
                ...
                <div class="col-xl-6 text-center text-xl-start">
                    ...
                    <div class="btn-group justify-content-center">
                        <a href="about.php" class="th-btn style3">Discover More<i class="far fa-arrow-right ms-2"></i></a>
                        <div class="call-btn">
                            <div class="play-btn">
            ...
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col-md-auto">
                    <div class="sec-btn mt-n3 mt-md-0">
                        <a href="project.php" class="th-btn style4">View All Projects<i class="far fa-arrow-right ms-2"></i></a>
                    </div>
                </div>
            </div>
            <div class="row gy-4">
                <div class="col-lg-6">
                    <div class="project-card">
                        ...
                        <div class="box-content">
                            ...
                            <a href="project-details.php" class="icon-btn"><i class="far fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="project-card">
                        ...
                        <div class="box-content">
                            <h3 class="box-title"><a href="project-details.php">Renovation of Roof</a></h3>
                            <a href="project-details.php" class="icon-btn"><i class="far fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-7 text-center text-xl-start align-self-center space-extra">
                    <div class="ps-xl-5 pb-30 pb-lg-0">
                        ...
                        <a href="contact.php" class="th-btn style4">Appointment Now<i class="far fa-arrow-right ms-2"></i></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="space">
        <div class="container z-index-common">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col-md-auto">
                    <div class="sec-btn mt-n3 mt-md-0">
                        <a href="team.php" class="th-btn style4">All Members<i class="far fa-arrow-right ms-2"></i></a>
                    </div>
                </div>
            </div>
            <div class="slider-area">
    ...
    <section class="space" id="testi-sec" data-bg-src="assets/img/bg/pattern_bg_1.png">
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col-md-auto">
                    <div class="sec-btn mt-n3 mt-md-0">
                        <a href="testimonial.php" class="th-btn style4">View All Reviews<i class="far fa-arrow-right ms-2"></i></a>
                    </div>
                </div>
            </div>
            <div class="slider-area">
