...
<head>
    ...
    <title>Rakar - Handyman Multipurpose Repairing Services HTML Template - Pricing Plan</title>
    ...
    <section class="space">
        <div class="container">
            <div class="title-area text-center">
                <span class="sub-title"><img src="assets/img/theme-img/title_icon.svg" alt="Icon">Pricing Plan</span>
                <h2 class="sec-title">Our Best Price we offer</h2>
            </div>
